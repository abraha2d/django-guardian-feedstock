...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-guardian-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-guardian-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-guardian
# for installing globally
pixi global install django-guardian
```
...
It is possible to list all of the versions of `django-guardian` available on your platform:
...
```
pixi search django-guardian --channel conda-forge
```
